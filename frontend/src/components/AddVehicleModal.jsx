            ...
            <form onSubmit={handleSubmit} className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    ...
                    <div className="md:col-span-2">
                        <label className="block text-sm font-semibold text-foreground mb-2">Initial Stock Quantity</label>
                ...
                <div className="mb-8">
                    <label className="block text-sm font-semibold text-foreground mb-2">Vehicle Images (1-5)</label>
                    <div 
                        onClick={() => fileInputRef.current?.click()}
                        className={`mt-2 flex justify-center rounded-xl border border-dashed border-border bg-secondary/30 px-6 py-8 hover:bg-secondary/50 transition-colors cursor-pointer ${images.length >= 5 ? 'opacity-50 pointer-events-none' : ''}`}
                    >
                        <div className="text-center">
                            <UploadCloud className="mx-auto h-10 w-10 text-muted-foreground mb-3" />
                            <div className="text-sm font-semibold text-foreground mb-1">Click to upload images</div>
                ...
                <div className="flex justify-end gap-3 pt-6 border-t border-border mt-4">
                    ...
                    <button type="submit" disabled={loading} className="rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground transition-colors hover:bg-primary/90 disabled:opacity-50 min-w-[120px]">
                        {loading ? 'Uploading...' : 'Save Vehicle'}
                    </button>
                </div>
            </form>
        </Modal>
